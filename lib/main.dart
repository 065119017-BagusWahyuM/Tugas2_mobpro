            ...
            children: [
              Container(
                  ...
                  child: const CircleAvatar(
                    backgroundImage: AssetImage('assets/images/bw.jpg'),
                    radius: 60,
                  )),
              Column(
                children: [
                  ...
                  Text("bagus.065119017@unpak.ac.id",
                      style: GoogleFonts.poppins(
                        fontSize: 12,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                        child: Text(
                      "Jl Raya Bogor KM 49, Kelurahan Nanggewer, Kecamatan Cibinong, Kabupaten Bogor, Jawa Barat, Indonesia, 16912",
                      style: GoogleFonts.poppins(
                        color: const Color.fromARGB(255, 197, 190, 190),
                        fontSize: 12,
                      ),
